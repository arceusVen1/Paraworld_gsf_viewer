...
class MeshSkinnedChunk extends Chunk {
  ...
  MeshSkinnedChunk.fromBytes(Uint8List bytes, int offset)
      : super(offset: offset, type: ChunkType.meshSkinned) {
    ...
    for (var i = 0; i < submeshInfoCount.value; i++) {
      final submesh = Submesh.fromBytes(
        bytes,
        submeshes.isNotEmpty ? submeshes.last.getEndOffset() : submeshMaterialsCount.offsettedLength,
      );
